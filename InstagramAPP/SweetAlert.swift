...
public class SweetAlert: UIViewController {
    ...
    private func setupTitleLabel() {
        ...
        ///////////
        titleLabel.textColor = UIColor.colorFromRGB(0xe88e92)
        ///////////
    }
    ...
    public func showAlert(title: String, subTitle: String?, style: AlertStyle,buttonTitle: String, action: ((isOtherButton: Bool) -> Void)? = nil) -> SweetAlert {
        ////////////////////////
        self.showAlert(title, subTitle: subTitle, style: style, buttonTitle: buttonTitle,buttonColor: UIColor.colorFromRGB(0xe88e92))
        ////////////////////////
        userAction = action
        return self
    }
...
class SuccessAnimatedView: AnimatableView {
    ...
    func setupLayers() {
        ...
        circleLayer.fillColor = UIColor.clearColor().CGColor;
        circleLayer.strokeColor = UIColor(red: 232 / 255, green: 142 / 255, blue: 146 / 255, alpha: 1.0).CGColor;
        circleLayer.lineCap = kCALineCapRound
        circleLayer.lineWidth = 4;
        circleLayer.actions = [
            "strokeStart": NSNull(),
